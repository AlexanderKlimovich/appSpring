package klymovych.dao;

import klymovych.models.Person;
...
public class PersonDAO {
    ...
    public Optional<Person> show(String email){
        return  jdbcTemplate.query("SELECT * FROM Person WHERE id=?", new Object[]{email}, new BeanPropertyRowMapper<>(Person.class))
                .stream().findAny();
    }
